...
#	print(sources)  
	...
	aperture_radius = 15
	annulus_radius_inner = aperture_radius+5
	annulus_radius_outer = aperture_radius+15
...
#	print(row)
	print("%3d"%(i+1),"of",total,":",filename,"%5.2f"%airmass,"%5.2f"%exptime,"%10.2f"%row[-1][5],row[-1][1],row[-1][2])
