...
# Keck, LRIS-Red Channel
kecklris_param = {
    'telescope_instrument': 'KECK/LRIS',  # telescope/instrument name
    'telescope_keyword': 'KECKLRIS',  # telescope/instrument keyword

    'observatory_code': '568',         # MPC observatory code
    'secpix': (0.135, 0.135),  # pixel size (arcsec)
    # before binning
    'ext_coeff': 0.05,          # typical extinction coefficient
    ...
    'radec_separator': ':',   # RA/Dec hms separator, use 'XXX'
    # if already in degrees
    'date_keyword': 'DATE-OBS|UTC',  # obs date/time
    # keyword; use
    # 'date|time' if
    # separate
    'obsmidtime_jd': 'MIDTIMJD',  # obs midtime jd keyword
    ...
    # pp_prepare
    'object': 'OBJECT',  # object name keyword
    'filter': 'REDFILT',  # filter keyword
    'filter_translations': {'I': 'I', 'R': 'R'},
    # filtername translation dictionary
    'exptime': 'EXPTIME',  # exposure time keyword (s)
    'airmass': 'AIRMASS',  # airmass keyword
...
# Keck, LRIS-Blue Channel
kecklrisblue_param = {
    'telescope_instrument': 'KECK/LRISBLUE',  # telescope/instrument name
    'telescope_keyword': 'KECKLRISBLUE',  # telescope/instrument keyword
    ...
    # pp_prepare
    'object': 'OBJECT',  # object name keyword
    'filter': 'BLUFILT',  # filter keyword
    'filter_translations': {'B': 'B'},
    # filtername translation dictionary
    'exptime': 'ELAPTIME',  # exposure time keyword (s)
    'airmass': 'AIRMASS',  # airmass keyword
...
# Palomar, WASP
palomarwasp_param = {
    'telescope_instrument': 'PALOMAR/WASP',  # telescope/instrument name
    'telescope_keyword': 'PALOMARWASP',  # telescope/instrument keyword

    'observatory_code': '675',         # MPC observatory code
    'secpix': (0.1743, 0.1743),  # pixel size (arcsec)
    # before binning
    'ext_coeff': 0.05,          # typical extinction coefficient
    ...
    'radec_separator': ':',   # RA/Dec hms separator, use 'XXX'
    # if already in degrees
    'date_keyword': 'UTC',  # obs date/time
    # keyword; use
    # 'date|time' if
    # separate
    'obsmidtime_jd': 'MIDTIMJD',  # obs midtime jd keyword
    # (usually provided by
    # pp_prepare
    'object': 'OBJECTA',  # object name keyword
    'filter': 'FILTER',  # filter keyword
    'filter_translations': {'Broad-RI': 'r'},
    # filtername translation dictionary
    'exptime': 'EXPTIME',  # exposure time keyword (s)
    'airmass': 'AIRMASS',  # airmass keyword
...
# NPOI PW1m, FLI
pw1fli_param = {
    'telescope_instrument': 'PW1m1/FLI',  # telescope/instrument name
    'telescope_keyword': 'PW1FLI',  # telescope/instrument keyword
...
# Lowell TiMo, G3-6300
timog3_param = {
    'telescope_instrument': 'TIMO/G3',  # telescope/instrument name
    'telescope_keyword': 'TIMOG3',  # telescope/instrument keyword

    'observatory_code': '690',         # MPC observatory code
    'secpix': (0.521, 0.521),  # pixel size (arcsec)
    # before binning
    'ext_coeff': 0.05,          # typical extinction coefficient
...
implemented_telescopes = ['VATT4K', 'DCTLMI', 'ARC35ARCTIC',
                          ...
                          'KECKLRIS','KECKLRISBLUE','PALOMARWASP', 'TIMOG3',
                          'PW1FLI']
...
telescope_parameters = {'VATT4K':       vatt4k_param,
                        ...
                        'KECKLRIS': kecklris_param,
                        'KECKLRISBLUE': kecklrisblue_param,
                        'PALOMARWASP': palomarwasp_param,
                        'TIMOG3': timog3_param,
                        'PW1FLI': pw1fli_param}
