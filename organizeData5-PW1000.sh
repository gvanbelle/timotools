#!/bin/bash
#
# use: organizeData5-PW1000.sh [nightID]
#     where nightID is in YYYYMMDD format
#
# Test for calibration data: flats, cals, logfiles
#
nightID="$1"
calRootDir="/mnt/c/Users/idle/Documents/ACP Astronomy/Images/"
fullRootDir="/mnt/c/Users/idle/Documents/ACP Astronomy/Images/Scheduler/Observatory Operator/"
...
#
# Rename, crop, and compress the files
#
echo ""
...
## crop files
##
echo "No file cropping for PW1000-1."
#echo ""
#echo "Cropping files from 3072x2048 to 2048x2048."
#python3 /home/idle/scripts/test-crop3b.py
#
# Copy the calibration tasks log files
#
echo ""
echo "Copy the log files."
logfileSourceRootDir="/mnt/c/Users/idle/Documents/ACP Astronomy/Logs/AutoFlat/"
...
#
#C:\Users\idle\OneDrive\Documents\ACP Astronomy\Logs\Scheduler\Observatory Operator
#
tasklogSourceRootDir="/mnt/c/Users/idle/Documents/ACP Astronomy/Logs/Scheduler/Observatory Operator/"
...
#
# copy last 24 hours from C:\Users\idle\OneDrive\Documents\ACP Astronomy\Scheduler Engine Logs to above Logs folder
#
...
schedulerLogsRootDir="/mnt/c/Users/idle/Documents/ACP Astronomy/Scheduler Engine Logs"
...
cd "$fullDataDirTarget"
echo ""
echo "Setting aside astrometric (binned 1x1) images."
/home/pw1000/scripts/astrometricCleanUp.sh

#
# bias-flat-dark files
#
cd "$fullDataDirTarget"
echo ""
echo "Bias/flat/darking images."
python3 /home/pw1000/scripts/biasFlatDark5b-PW1000.py


##
## compress files
## currently commented out because it slows things down too much
##
