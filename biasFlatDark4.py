...
for filt in flat_filters:
    ...
    #        closest_dark = find_nearest_dark_exposure(reduced, combined_darks.keys())
            ...
            reduced = ccdp.ccd_process(ccd, master_bias=combined_bias, dark_frame=combined_dark, master_flat=good_flat,
                                        gain=1.5*u.electron/u.adu, dark_exposure=600, data_exposure='exptime',
                                        exposure_unit=u.second, readnoise=12, gain_corrected=False, dark_scale=True)
            ...
            reduced.write(filterOutputPath / file_name)
    else:
